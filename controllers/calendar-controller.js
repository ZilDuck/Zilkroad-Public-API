...
module.exports = {
    ...
    {
      const fetchData = await calendar.GetCalendarForPeriod(period, limit, offset, timezone, cacheTime)
      await cache.SetKey(`GetCalendarForPeriod-${period}-${offset}-${limit}-${timezone}`, fetchData)
      res.send(fetchData)
    }
    else
    {
