...
async function getSearchForFreetext(freetext)
{
    try
    {
        ...
        query.rows.forEach(function(object) {
            object.zil_address = validation.isBech32(object.nonfungible_address) ? object.nonfungible_address : toBech32Address(object.nonfungible_address)
            object.result_action = '/collections/' + object.zil_address
        })
